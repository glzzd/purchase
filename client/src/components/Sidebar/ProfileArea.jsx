  ...
  return (
    <div className="bg-[#444444] px-4 rounded-3xl">
      <div className="flex justify-center gap-2 items-center">
        <div className="h-10 w-10 text-[#242424] font-bold bg-amber-300 rounded-4xl flex justify-center items-center">{`${userData.surname[0].toUpperCase()}${userData.name[0].toUpperCase()}`}</div>
